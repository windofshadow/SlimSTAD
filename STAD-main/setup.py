    ...
    setup(
        ...
        ext_modules=[
            CUDAExtension('boundary_max_pooling_cuda', [
                'tf-logs/Amend-3_Backbone_I3D-num0-9/AFSD/prop_pooling/boundary_max_pooling_cuda.cpp',
                'tf-logs/Amend-3_Backbone_I3D-num0-9/AFSD/prop_pooling/boundary_max_pooling_kernel.cu'
            ])
        ],
        cmdclass={
